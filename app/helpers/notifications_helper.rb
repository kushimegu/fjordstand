module NotificationsHelper
  def resolve_redirect_path(notification)
    NotificationsHelper::Strategy.for(notification).redirect_path
  end

  def resolve_message(notification)
    NotificationsHelper::Strategy.for(notification).message
  end
